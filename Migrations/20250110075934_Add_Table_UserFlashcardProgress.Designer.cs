...
namespace Quizlet-Clone.Migrations
{
    ...
    [Migration("20250110075934_Add_Table_UserFlashcardProgress")]
    partial class Add_Table_UserFlashcardProgress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a4e4b19d-d661-4b6d-82c9-666e0281b22d",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "ef23c874-dfe0-4b53-bd39-3f256ecc7e57",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("SmartCards.Models.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "en",
                            CreatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(298),
                            Name = "English",
                            UpdatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(299)
                        },
                        new
                        {
                            Id = 2,
                            Code = "fr",
                            CreatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(301),
                            Name = "French",
                            UpdatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(301)
                        },
                        new
                        {
                            Id = 3,
                            Code = "de",
                            CreatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(303),
                            Name = "German",
                            UpdatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(303)
                        },
                        new
                        {
                            Id = 4,
                            Code = "es",
                            CreatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(305),
                            Name = "Spanish",
                            UpdatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(305)
                        },
                        new
                        {
                            Id = 5,
                            Code = "it",
                            CreatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(307),
                            Name = "Italian",
                            UpdatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(307)
                        },
                        new
                        {
                            Id = 6,
                            Code = "pt",
                            CreatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(309),
                            Name = "Portuguese",
                            UpdatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(309)
                        },
                        new
                        {
                            Id = 7,
                            Code = "zh",
                            CreatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(310),
                            Name = "Chinese",
                            UpdatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(311)
                        },
                        new
                        {
                            Id = 8,
                            Code = "ja",
                            CreatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(312),
                            Name = "Japanese",
                            UpdatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(313)
                        },
                        new
                        {
                            Id = 9,
                            Code = "ru",
                            CreatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(344),
                            Name = "Russian",
                            UpdatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(345)
                        },
                        new
                        {
                            Id = 10,
                            Code = "ar",
                            CreatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(346),
                            Name = "Arabic",
                            UpdatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(347)
                        },
                        new
                        {
                            Id = 11,
                            Code = "vn",
                            CreatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(348),
                            Name = "Việt Nam",
                            UpdatedAt = new DateTime(2025, 1, 10, 14, 59, 33, 968, DateTimeKind.Local).AddTicks(349)
                        });
                });
